  ...
  const [timePressed, setTimePressed] = React.useState(false);
    ...
    const [coreSquarePressed, setCoreSquarePressed] = React.useState<{ [key: string]: boolean }>({
      Mo: false,
      Tu: false,
      We: false,
      Th: false,
    ...
    const daysOfWeek = ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'] //Array for CoreSquares text
      ...
      const selectedDays = Object.keys(coreSquarePressed).filter(day => coreSquarePressed[day]);
    ...
    return (
        ...
        {/* Date + squares */}
          <View style={styles.viewBox}>
              <View style={{
                  ...
                  <Text style={styles.heading}>Days
                    {/* {habbitText} */}
                    </Text>
                  </View>
              </View>
      ...
      <View style={styles.viewBox}>
        ...
        <Pressable 
          ...
          style={styles.button}
        >
          <Text style={[ styles.buttonText, { color: timePressed ? Colors.purple : Colors.lightGray}, { opacity: timePressed ? 1 : 0.3} ]}>
            {`${formattedTime}`}
          </Text>
        </Pressable>
